...
const BackgroundProfile = ({ setBtnOption, btnOption, name = '', email = '', options }: BacgroundProps) => {
      ...
      >
        ...
        >
          ...
          <Flex direction="column" maxWidth="100%" my={{ sm: '14px' }}>
            ...
            <Text fontSize={{ sm: 'sm', md: 'md' }} color={'gray.400'} fontWeight="semibold">
              {email}
            </Text>
          </Flex>
        </Flex>
        <Flex direction={{ base: 'column', lg: 'row' }} w={{ sm: '100%', md: '50%', lg: 'auto' }}>
          {options.map((op) => (
            <Button
              key={op.value}
